    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="http://bankasdu.lt/home.php" class="nav-link px-2 text-white"><img style="filter: invert(70%);" class="d-block  pb-6" src="./home.png" alt="pig" height="45"></a></li>
                <li><a href="http://bankasdu.lt/home.php" class="nav-link px-2 text-white p-4">Add Account</a></li>
