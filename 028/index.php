            ...
            <div class="col-4">
                <div class="card m-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="http://localhost/bit_php/028/create.php" method="post">
                            <div class="mb-3">
                ...
                <div class="card m-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="http://localhost/bit_php/028//edit.php" method="post">
                            <div class="mb-3">
                                <label class="form-label">height</label>
                                <input type="text" name="height" class="form-control">
                            </div>
                ...
                <div class="card m-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="http://localhost/bit_php/028/delete.php" method="post">
                            <div class="mb-3">
                                <label class="form-label">ID</label>
                                <input type="text" name="id" class="form-control">
                            </div>
